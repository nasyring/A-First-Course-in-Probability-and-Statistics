...
```{r, echo = F}
knitr::include_graphics("rsediagram.PNG")
```
...
```{r, echo = F}
o_ring <- read.csv('o_ring_data.txt', sep = ' ')
colnames(o_ring) <- c('at risk','failed','launch temp.')
knitr::kable(
  o_ring[,1:3], booktabs = TRUE,
  caption = 'A table of o rings at risk, o ring failires, and launch temperatures of space shuttle flights.'
)
```
