...
\hypertarget{tests-for-a-normal-mean-when-the-variance-is-known}{%
\subsection{Tests for a normal mean when the variance is known}\label{tests-for-a-normal-mean-when-the-variance-is-known}}
