...
\includegraphics{10-Sampling-Distributions_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{crops <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"crop.data.csv"}\NormalTok{, }\DataTypeTok{header =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{colClasses =} \KeywordTok{c}\NormalTok{(}\StringTok{"factor"}\NormalTok{, }\StringTok{"factor"}\NormalTok{, }\StringTok{"factor"}\NormalTok{, }\StringTok{"numeric"}\NormalTok{))}
\NormalTok{m <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(crops$yield)}
\NormalTok{m1 <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(crops$yield[crops$fertilizer ==}\StringTok{ }\DecValTok{1}\NormalTok{])}
\NormalTok{m2 <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(crops$yield[crops$fertilizer ==}\StringTok{ }\DecValTok{2}\NormalTok{])}
\NormalTok{m3 <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(crops$yield[crops$fertilizer ==}\StringTok{ }\DecValTok{3}\NormalTok{])}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{length}\NormalTok{(crops$yield)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sum}\NormalTok{(crops$fertilizer ==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sum}\NormalTok{(crops$fertilizer ==}\StringTok{ }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sum}\NormalTok{(crops$fertilizer ==}\StringTok{ }\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# SSTr}
\NormalTok{n <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(crops$fertilizer ==}\StringTok{ }\DecValTok{1}\NormalTok{)}
\NormalTok{n}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(A$residuals)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{qqnorm}\NormalTok{(A$residuals)}
\KeywordTok{qqline}\NormalTok{(A$residuals)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sd}\NormalTok{(crops$yield[crops$fertilizer==}\DecValTok{1}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sd}\NormalTok{(crops$yield[crops$fertilizer==}\DecValTok{2}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sd}\NormalTok{(crops$yield[crops$fertilizer==}\DecValTok{3}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{crops$resid <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{abs}\NormalTok{(crops$yield[crops$fertilizer==}\DecValTok{1}\NormalTok{]-}\KeywordTok{mean}\NormalTok{(crops$yield[crops$fertilizer==}\DecValTok{1}\NormalTok{])),}
\KeywordTok{abs}\NormalTok{(crops$yield[crops$fertilizer==}\DecValTok{2}\NormalTok{]-}\KeywordTok{mean}\NormalTok{(crops$yield[crops$fertilizer==}\DecValTok{2}\NormalTok{])),}
\KeywordTok{abs}\NormalTok{(crops$yield[crops$fertilizer==}\DecValTok{3}\NormalTok{]-}\KeywordTok{mean}\NormalTok{(crops$yield[crops$fertilizer==}\DecValTok{3}\NormalTok{])))}

\KeywordTok{summary}\NormalTok{(}\KeywordTok{aov}\NormalTok{(resid ~}\StringTok{ }\NormalTok{fertilizer, }\DataTypeTok{data =} \NormalTok{crops))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ml <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(crops$resid)}
\NormalTok{m1l <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(crops$resid[crops$fertilizer ==}\StringTok{ }\DecValTok{1}\NormalTok{])}
\NormalTok{m2l <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(crops$resid[crops$fertilizer ==}\StringTok{ }\DecValTok{2}\NormalTok{])}
\NormalTok{m3l <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(crops$resid[crops$fertilizer ==}\StringTok{ }\DecValTok{3}\NormalTok{])}
